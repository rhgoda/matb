<section class="mb-40">  
    ...
    <div class="container mx-auto xl:px-32">
        ...
        <div class="mt-12 lg:mt-0">
            <h1 class="text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12">Лучшее решение <br /><span class="text-blue-600">для вашего бизнеса</span></h1>
        </div>
        <div class="mb-12 lg:mb-0">
            <img src="assets/icon.png" class="w-full rounded-lg" alt=""/>
        </div>
        </div>
    </div>
    </div>
